...
<body>
  <div class="panel">
    ...
    <div class="panel-body">
      <h2>Action Denied</h2>
      <p>You are not authorized to remove this product, or it does not exist.</p>
      <a href="${removeAnotherLink}" class="btn btn-primary">Remove Another Product</a>
